...
- Αφορά μεγάλα tasks
    - Φτιάξε ένα νέο Custom Post type: αγγελία
- Το πιο σημαντικό για αρχάριους;
  - **PLANNING** (Σχεδιασμός)
- Πριν γράψει κώδικα, σχεδιάζει την προσέγγιση
- Εσείς εγκρίνετε ή ζητάτε αλλαγές
- Αποφεύγει λάθη και ξαναγράψιμο
